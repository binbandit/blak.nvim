      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Bash", slug: "extras/lang/bash" },
            { label: "C/C++", slug: "extras/lang/c" },
            { label: "Docker", slug: "extras/lang/docker" },
            { label: "JSON", slug: "extras/lang/json" },
            { label: "Nix", slug: "extras/lang/nix" },
            { label: "Tailwind CSS", slug: "extras/lang/tailwind" },
            { label: "Terraform", slug: "extras/lang/terraform" },
            { label: "Web", slug: "extras/lang/web" },
            { label: "YAML", slug: "extras/lang/yaml" },
            { label: "Zig", slug: "extras/lang/zig" },
            ...
            { label: "Indent guides", slug: "extras/ui/indent" },
            ...
            { label: "Git Browse", slug: "extras/git/gitbrowse" },
            { label: "Neogit", slug: "extras/git/neogit" },
            ...
            { label: "Emmet", slug: "extras/editor/emmet" },
            { label: "Flash", slug: "extras/editor/flash" },
            { label: "Find & replace", slug: "extras/editor/grug-far" },
            { label: "Scratch", slug: "extras/editor/scratch" },
